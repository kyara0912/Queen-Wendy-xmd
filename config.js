...
global.anitav4 = process.env.BOT_NAME || "𝐏𝐑𝐄𝐓𝐓𝐘_𝐃𝐄𝐄𝐒-𝐕𝟒";
global.ownername = process.env.OWNER_NAME || "Cabrino Killua";
global.packname = process.env.PACK_NAME || "𝐏𝐑𝐄𝐓𝐓𝐘_𝐃𝐄𝐄𝐒-𝐕𝟒";
global.author = process.env.AUTHOR || "𝐂𝐀𝐁𝐑𝐈𝐍𝐎 𝐊𝐈𝐋𝐋𝐔𝐀";
global.channelname = process.env.CHANNEL_NAME || "𝐂𝐀𝐁𝐑𝐈𝐍𝐎 𝐊𝐈𝐋𝐋𝐔𝐀";
